    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-primary px-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <h1 className="text-2xl font-semibold text-text-primary">Worknoon Chat</h1>
        ...
        <div className="mt-6 rounded-xl border border-border-glass bg-bg-glass/50 px-4 py-3 text-center text-xs text-text-muted backdrop-blur-sm">
